...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i3.RemoteDataSource>(() => _i4.RemoteDataSourceImpl());
    gh.factory<_i5.HouseWorkRepository>(() => _i6.HouseWorkRepositoryImpl(
        remoteDataSource: gh<_i3.RemoteDataSource>()));
    gh.lazySingleton<_i7.GetFamilyInfoUseCase>(() => _i7.GetFamilyInfoUseCase(
        houseWorkRepository: gh<_i5.HouseWorkRepository>()));
    return this;
  }
}
